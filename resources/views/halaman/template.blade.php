...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <marquee><h3 style="color:yellow;">{{date('Y-m-d')}}</h3></marquee>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <a href="http://adminlte.io">GemaFajarRamadhan</a></strong>
